	 ...
	 public static void main(String[] args) throws InterruptedException, IOException
	  {
		...
		//way2-DownCasting from webDriver(I) to RemoteWebDriver(Class)
		//create object for RemoteWebDriver(Class)
		RemoteWebDriver rwd = (RemoteWebDriver)driver;
		
		//using method screen shot store in src ref variable(src-source)
		File src = rwd.getScreenshotAs(OutputType.FILE); //return type file
		
		//right destination to store file
		File dest = new File("./ScreenShots/Way2ScreenShot.png");
